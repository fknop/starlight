...
Dans cette section, nous présentons les différentes conventions 
...
Les fichiers sont entièrement en minuscule et possèdes les extensions .h
...
séparés par des underscore et le nom finit par un underscore.

\begin{itemize}
	\item variable\_
	\item nom\_variable\_
\end{itemize}

Cette convention est également valable pour les énumérations et structures.
...
Le nom d'un getter (accesseur en lecture de variable de classe)
est égal au nom 
de la variable de classe sans l'underscore final.

\begin{itemize}
	\item Variable : variable\_ - Getter : variable()
	\item Variable : nom\_var\_ - Getter : nom\_var()
\end{itemize}

\subsubsection{Setters}

Le nom d'un setter (accesseur en écriture de variable de classe)
est égal au nom de la variable sans l'underscore final précédé
d'un set.

\begin{itemize}
	\item Variable : variable\_ - Setter : set\_variable()
	\item Variable : nom\_var\_ - Setter : set\_nom\_var()
\end{itemize}
