...
une liste (\texttt{vector}) d'observateurs. Un observé peut lancer des notifications
via la méthode :
\begin{lstlisting}
...
\texttt{SourceView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{DestinationView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{WallView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{MirrorView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{LensView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{CrystalView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
...
\texttt{NukeView} hérite de l'interface \texttt{ObserverInterface} (cf. \hyperref[OO]{''Observable/Observer''}) et observe
