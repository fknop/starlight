...
Le segment peut être transformé en droite gràce aux deus points
...
il suffit d'augmenter ou dimunier l'angle $ q $ par un angle $ f $ comme ceci :

$$ x' = r * \cos{q + f} $$
$$ y' = r * \sin{q + f} $$

Gràce aux formules trigonométriques d'additions, on peut transformer ce résultat en :
