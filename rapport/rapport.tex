...
\paragraph{Dans l'interface} La source peut être allumée grâce à un double 
clic. Elle possède une image d'ampoule qui est éteinte ou allumée.
...
\paragraph{Dans l'interface} La destination devient verte une fois atteinte.
De plus, un message de victoire est affiché.
...
\paragraph{Dans l'interface} Les murs sont des lignes de couleurs noires.
