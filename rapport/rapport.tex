...
Le projet fini permet de jouer à Starlight en important sa propre
carte de jeu au format \texttt{.lvl} qu'il est possible de créer
soi même gràce à l'éditeur de carte. Ce dernier permet d'importer
une carte existante et de la modifier et d'ensuite la sauvegarder.
Il est possible de jouer directement dans l'éditeur pour pouvoir
tester directement son niveau. Les bombes et la destinations ont donc été
désactivées pour éviter des sons et pop-ups intempestifs.
