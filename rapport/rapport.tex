...
Les méthodes qui override une méthode d'une super-classe possèdent le mot-clé override.
...
Les tests unitaires du projet ont été fait grâce au framework Catch. Le projet possède environs 180 tests unitaires (assertions).
...
Le modèle est prévu pour gérer les intersections avec les différents objets du niveau et de réfléchir le rayon s’il arrive sur le miroir. 
