...
{\em p2} & la fin du mur. \\
\hline
{\em movable} & vrai si le mur est déplaçable, faux sinon. \\
\hline
\end{DoxyParams}
...
la fin du mur. 
\end{DoxyReturn}
\hypertarget{classWall_a1f834d6f719d7b5ac4ae2428fef627e4}{\index{Wall@{Wall}!movable@{movable}}
\index{movable@{movable}!Wall@{Wall}}
\subsubsection[{movable}]{\setlength{\rightskip}{0pt plus 5cm}bool Wall\+::movable (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classWall_a1f834d6f719d7b5ac4ae2428fef627e4}


Retourne vrai si le mur est déplaçable. 

\begin{DoxyReturn}{Renvoie}
vrai si le mur est déplaçable. 
\end{DoxyReturn}
